...
import "./chunk-QSG4QLTM.js";
import {
  createSeriesData_default
} from "./chunk-MCZXZ6XJ.js";
import {
  install as install3
} from "./chunk-OGHFOERI.js";
import "./chunk-RH47S6EJ.js";
import "./chunk-44QBACBE.js";
import {
...
import {
  ...
  install as install2
} from "./chunk-GZ22AX3O.js";
import {
  getLabelLineStatesModels,
  setLabelLineStyle
} from "./chunk-OLCBX7WC.js";
import {
  prepareSeriesDataSchema
} from "./chunk-PPWP7CBN.js";
import {
  DataDiffer_default,
  SeriesData_default,
...
function createViewCoordSys(ecModel, api) {
  ...
  ecModel.eachSeriesByType("graph", function(seriesModel) {
    ...
    if (!coordSysType || coordSysType === "view") {
      ...
      var viewRect = getViewRect2(seriesModel, api, aspect);
      if (isNaN(aspect)) {
...
function funnelLayout(ecModel, api) {
  ecModel.eachSeriesByType("funnel", function(seriesModel) {
    ...
    var viewRect = getViewRect3(seriesModel, api);
    var orient = seriesModel.get("orient");
    var viewWidth = viewRect.width;
    var viewHeight = viewRect.height;
...
function sankeyLayout(ecModel, api) {
  ecModel.eachSeriesByType("sankey", function(seriesModel) {
    ...
    var layoutInfo = getViewRect4(seriesModel, api);
    seriesModel.layoutInfo = layoutInfo;
    var width = layoutInfo.width;
    var height = layoutInfo.height;
    var graph = seriesModel.getGraph();
